...
@{
    ...
    GUID              = '59c645ff-0cc5-422b-9c7b-8cc7f1ed4c0e'
    ...
    Description       = 'This module contains PowerShell Desired State Configuration solutions for running integration tests with xFailOverCluster.'
    ...
    RequiredModules   = @('PSDscResources','xActiveDirectory','xComputerManagement')
